...
public class milk3 {
	public static void main(String[] args) throws Exception {
		BufferedReader f = new BufferedReader(new FileReader("D:/git/usaco-practice/src/isumi/milk2/milk2.in"));
		PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("D:/git/usaco-practice/src/isumi/milk2/milk2.out")));
